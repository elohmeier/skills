module github.com/elohmeier/skills/grafana-dashboard-v2-tool

go 1.26.5

require (
	github.com/grafana/grafana/apps/dashboard v0.0.0-20260806140417-c8734a41e7cd
	github.com/grafana/grafana/pkg/apimachinery v0.0.0-20260806140417-c8734a41e7cd
...
require (
	...
	github.com/grafana/grafana-app-sdk v0.56.6 // indirect
